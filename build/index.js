...
var Rabbit = (function () {
                        ...
                        switch (_b.label) {
                            ...
                            case 2:
                                ...
                                connection.on('close', function () {
                                    ...
                                    if (!_this.stopping) {
                                        _this.connecting = establishConnection();
                                    }
                                });
    ...
    Rabbit.prototype.createWorker = function (scope, handler, options) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Rabbit.prototype.createPublisher = function (scope) {
        return __awaiter(this, void 0, void 0, function () {
            var connection, publisher;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.connecting];
                    case 1:
                    ...
                    case 2:
                        ...
                        return [2, function (topic) {
                                ...
                                return __awaiter(this, void 0, void 0, function () {
                                    return __generator(this, function (_a) {
                                        return [2, publisher.send.apply(publisher, [topic].concat(args))];
                                    });
                                });
                            }];
                }
    ...
    Rabbit.prototype.createSubscriber = function (scope, handler, options) {
        return __awaiter(this, void 0, void 0, function () {
            var connection, subscriber;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.connecting];
                    case 1:
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.stopping = true;
                        return [4, Promise.all(this.channels.map(function (channel) { return channel.stop(); }))];
                    case 1:
                        _a.sent();
                        if (!this.connection) return [3, 3];
