...
var Worker = (function () {
    function Worker(connection, queue, handler, options) {
                                                    ...
                                                    switch (_a.label) {
                                                        case 0:
                                                            ...
                                                            logger_1.default
                                                                .tag('worker')
                                                                .tag('request')
                                                                .verbose({ queue: this.queue, request: request });
                                                            response = { correlationId: correlationId };
                                                            _a.label = 1;
                                                        case 1:
                                                            _a.trys.push([1, 4, , 5]);
                                                            result = this.handler.apply(this.handler, request.arguments);
                                                        ...
                                                        case 6:
                                                            ...
                                                            return [4, this.channel.sendToQueue(message.properties.replyTo, new Buffer(JSON.stringify(response)), { correlationId: correlationId, persistent: true })];
                                                        case 7:
                                                            _a.sent();
                                                            return [2];
                                                    }
